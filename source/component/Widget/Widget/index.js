...
const CSS_WIDGET = 'widget-global-style'
...
class WidgetRect extends PureComponent {
  ...
  render () {
    ...
    return <div {...{
      ref: this.setRef,
      className: `${CSS_WIDGET} rect ${isSelect ? ' select' : ''} ${isLock ? 'lock' : ''}`,
...
class WidgetLine extends PureComponent {
  ...
  render () {
    ...
    return <div {...{
      ref: this.setRef,
      className: `${CSS_WIDGET} line ${isSelect ? ' select' : ''} ${isLock ? 'lock' : ''}`,
      style: getRectTransformStyle(widget, zoom)
    }} />
  }
}
...
class WidgetElbow extends PureComponent {
  ...
  render () {
    ...
    return <div {...{
      ref: this.setRef,
      className: `${CSS_WIDGET} elbow ${isSelect ? ' select' : ''} ${isLock ? 'lock' : ''}`,
      style: getRectTransformStyle(widget, zoom)
    }}>
...
export {
  WidgetGlobalStyle,
  WidgetRect, WidgetLine, WidgetElbow,
  renderWidget
}
